                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className='relative' ref={dropdownRef}>
                            <button
                                ...
                                className="flex items-center gap-2 px-3 p-2 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors"
                            >
                            ...
                            {isDropdownOpen && (
                                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                                    ...
                                    <button
                                        ...
                                        className="w-full text-left px-4 py-2 text-sm text-red-700 hover:text-red-900 hover:bg-gray-100 transition-colors flex items-center gap-2"
                                    >
